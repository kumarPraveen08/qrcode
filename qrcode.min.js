      ...
      ? (function () {
          ...
          var e = function (a, b) {
            (this._bIsPainted = !1),
              (this._android = n()),
              (this._htOption = b),
              (this.margin = b.width / 6),
              (this._elCanvas = document.createElement("canvas")),
              (this._elCanvas.width = b.width + this.margin),
              (this._elCanvas.height = b.height + this.margin),
          ...
          return (
            (e.prototype.draw = function (a) {
              ...
              c.fillStyle = d.colorLight;
              c.fillRect(0, 0, this._elCanvas.width, this._elCanvas.height);
              for (var j = 0; e > j; j++)
                for (var k = 0; e > k; k++) {
                  var l = a.isDark(j, k),
                    m = k * f + this.margin / 2,
